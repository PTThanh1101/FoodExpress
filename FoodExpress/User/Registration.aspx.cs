        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            if (fuUserImage.HasFile)
            {
                if (Utils.IsValidExtension(fuUserImage.FileName))
                {
                    ...
                    cmd.Parameters.AddWithValue("@ImageUrl", imagePath); isValidToExecute = true;
                }
                else
                {
                    lblMsg.Visible = true;
            ...
            if (isValidToExecute)
            {
                ...
                catch (SqlException ex)
                {
                    ...
                    {
                        lblMsg.Visible = true;
                        lblMsg.Text = "<b>" + txtUsername.Text.Trim() + "</b> username or <b>" + txtEmail.Text.Trim() + "</b> email already exists (OR BOTH), try new ones..!";
                        lblMsg.CssClass = "alert alert-danger";
                    }
                }
                catch (Exception ex)
