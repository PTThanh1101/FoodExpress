...
namespace FoodExpress.User
{
    public partial class Invoice : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (Session["userId"] != null)
                {
                    ...
                    {
                        reOrderItem.DataSource = GetOrderDetails();
                        reOrderItem.DataBind();
                    }
                }
                else
                {
        ...
        protected void lbDownloadInvoice_Click(object sender, EventArgs e)
        {
            try
            {
                string downloadPath = @"D:\NAM 4 - 1B\Đồ Án\order_invoice.pdf";
        ...
        void ExportToPdf(DataTable dtblTable, String strPdfPath, string strHeader)
        {
            ...
            prgAuthor.Add(new Chunk("Order From : FoodExpress", fntAuthor));
