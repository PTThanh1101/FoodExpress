<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="FoodExpress.User.Payment" %>
            ...
            <div class="row">
                <div class="col-lg-6 mx-auto">
                    <div class="card ">
                            ...
                            <div class="tab-content">
                                    ...
                                    <div role="form">
                                        <div class="form-group">
                                            ...
                                            <asp:RegularExpressionValidator ID="revName" runat="server"
                                                ErrorMessage="Name must be characters" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                                                ValidationExpression="^[a-zA-z\s]+$" ControlToValidate="txtName" ValidationGroup="card">*
                                            </asp:RegularExpressionValidator>
                                            <asp:TextBox ID="txtName" runat="server" CssClass="form-control" placeholder="Card Owner Name">
                                            </asp:TextBox>
                                        </div>
                                        <div class="form-group">
                                            <label for="txtCardNo">
                                            ...
                                            <asp:RequiredFieldValidator ID="rvfCardNo" runat="server" ErrorMessage="Card Number is required"
                                                ControlToValidate="txtCardNo" ForeColor="Red" Display="Dynamic"
                                                SetFocusOnError="true" ValidationGroup="card">*</asp:RequiredFieldValidator>
                                            <asp:RegularExpressionValidator ID="revCardNo" runat="server"
                                                ErrorMessage="Card number must contain 16 digits" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <div class="form-group">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="refExpMonth" runat="server" ErrorMessage="Expiry month is required"
                                                        ControlToValidate="txtExpMonth" ForeColor="Red" Display="Dynamic"
                                                        SetFocusOnError="true" ValidationGroup="card">*</asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="revExpMonth" runat="server"
                                                        ErrorMessage="Expiry month must contain 2 digits" ForeColor="Red" Display="Dynamic"
                                                        SetFocusOnError="true" ValidationExpression="[0-9]{2}" ControlToValidate="txtExpMonth"
                                                        ValidationGroup="card">*</asp:RegularExpressionValidator>
                                                    <asp:RequiredFieldValidator ID="rvfExpYear" runat="server" ErrorMessage="Expiry year is required"
                                                        ControlToValidate="txtExpYear" ForeColor="Red" Display="Dynamic"
                                                        SetFocusOnError="true" ValidationGroup="card">*</asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="revExpYear" runat="server"
                                                        ErrorMessage="Expiry year must contain 2 digits" ForeColor="Red" Display="Dynamic"
                                                        SetFocusOnError="true" ValidationExpression="[0-9]{4}" ControlToValidate="txtExpYear"
                                                        ValidationGroup="card">*</asp:RegularExpressionValidator>
                                                    <div class="input-group">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="refCvv" runat="server" ErrorMessage="CVV number is required"
                                                        ControlToValidate="txtCvv" ForeColor="Red" Display="Dynamic"
                                                        SetFocusOnError="true" ValidationGroup="card">*</asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="revCvv" runat="server"
                                                        ErrorMessage="CVV number must contain 3 digits" ForeColor="Red" Display="Dynamic"
                                                        SetFocusOnError="true" ValidationExpression="[0-9]{3}" ControlToValidate="txtCvv"
                                                        ValidationGroup="card">*</asp:RegularExpressionValidator>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtAddress" runat="server" CssClass="form-control" TextMode="MultiLine"
                                                placeholder="Delivery Address" ValidationGroup="card">
                                            </asp:TextBox>
                                        </div>
                                ...
                                <div id="paypal" class="tab-pane fade pt-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtCODAddress" runat="server" CssClass="form-control" TextMode="MultiLine"
                                            placeholder="Delivery Address">
                                        </asp:TextBox>
                                    </div>
                                    <p>
                                        <asp:LinkButton ID="lbCodSubmit" runat="server" CssClass="btn btn-info" ValidationGroup="cod"
                                            OnClick="lbCodSubmit_Click">
                                        <i class="fa fa-cart-arrow-down mr-2"></i>Confirm Order</asp:LinkButton>
                                    </p>
                                    <p class="text-muted">
                                        Note: At the time you receive your order, you need to do full payment.
                        ...
                        <div class="card-footer">
                            <b class=" badge badge-success badge-pill shadow-sm">Order Total: <% Response.Write(Session["grandTotalPrice"]); %>VND</b>
                            <div class="pt-1">
