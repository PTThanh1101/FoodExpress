...
namespace FoodExpress.User
{
    public partial class Payment : System.Web.UI.Page
    {
        ...
        void OrderPayment(string name, string cardNo, string exipryDate, string cvv, string address, string paymentMode)
        {
            int paymentId;
            int productId;
            int quantity;
            ...
            cmd.Parameters.AddWithValue("@ExpiryDate", exipryDate);
