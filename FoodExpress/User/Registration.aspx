<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="FoodExpress.User.Registration" %>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form_container">
                        <div>
                            ...
                            <asp:RegularExpressionValidator ID="revName" runat="server" ErrorMessage="Name must be in character form only"
                        ...
                        <div>
                            <asp:RequiredFieldValidator ID="rvfUsernmae" runat="server" ErrorMessage="Username is required"
                        ...
                        <div>
                            <asp:RequiredFieldValidator ID="rvfPhone" runat="server" ErrorMessage="Phone Number is required"
                                ControlToValidate="txtPhone" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            ...
                            <asp:TextBox ID="txtPhone" runat="server" CssClass="form-control" placeholder="Enter Phone Number"
                                ToolTip="Phone" TextMode="Number"></asp:TextBox>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form_container">
                        <div>
                            <asp:RequiredFieldValidator ID="rvfAddress" runat="server" ErrorMessage="Address is required"
                        ...
                        <div>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Post/Zip Code is required"
                        ...
                        <div>
                            <asp:RequiredFieldValidator ID="rvfPassword" runat="server" ErrorMessage="Password is required"
