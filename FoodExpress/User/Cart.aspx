<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="FoodExpress.User.Cart" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="book_section layout_padding">
        ...
        <div class="container">
            <asp:Repeater ID="reCartItem" runat="server" OnItemCommand="reCartItem_ItemCommand"
                OnItemDataBound="reCartItem_ItemDataBound">
                <HeaderTemplate>
                    <table class="table">
                        <thead>
                            <th>Name</th>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <img width="60" src="<%# FoodExpress.Utils.GetImageUrl(Eval("ImageUrl")) %>" alt="" />
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:LinkButton ID="lbDelete" runat="server" Text="Remove" CommandName="remove"
                                ...
                                OnClientClick="return confirm('Do you really want to remove this item from your shopping cart?');">
