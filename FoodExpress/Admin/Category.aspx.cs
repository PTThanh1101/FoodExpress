...
namespace FoodExpress.Admin
{
    public partial class Category : System.Web.UI.Page
    {
        ...
        protected void reCategory_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            lblMsg.Visible = false;
            con = new SqlConnection(Connection.GetConnectionString());
        ...
        protected void reCategory_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
