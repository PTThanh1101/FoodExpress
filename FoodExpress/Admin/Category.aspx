<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="FoodExpress.Admin.Category" %>

<%@ Import Namespace="FoodExpress" %>
                                        ...
                                        <div class="col-sm-6 col-md-8 col-lg-8 mobile-inputs">
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    ...
                                                    <asp:Repeater ID="reCategory" runat="server" OnItemCommand="reCategory_ItemCommand"
                                                        OnItemDataBound="reCategory_ItemDataBound">
                                                        <HeaderTemplate>
