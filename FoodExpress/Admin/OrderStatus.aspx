<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="OrderStatus.aspx.cs" Inherits="FoodExpress.Admin.OrderStatus" %>
                                        ...
                                        <div class="col-sm-6 col-md-8 col-lg-8">
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    ...
                                                    <asp:Repeater ID="reOrderStatus" runat="server" OnItemCommand="reOrderStatus_ItemCommand">
                                                        <HeaderTemplate>
                                                            <table class=" table data-table-export table-hover nowrap">
                                                                <thead>
                                                                    <tr>
                                                                        <th class="table-plus">Payment ID</th>
                                                                        <th>Order Date</th>
                                                                        <th>Product Name</th>
                                                                        <th>Total Price</th>
                                                                        <th>Status</th>
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                <td class="table-plus"> <%# Eval("PaymentId") %> </td>
                                                                <td> <%# Eval("OrderDate") %> </td>
                                                                <td><%# Eval("ProductNames") %></td>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lnkEdit" Text="Edit" runat="server" CssClass="badge badge-primary"
                                                                        CommandArgument='<%# Eval("PaymentId") %>' CommandName="edit">
                                                                    <i class="ti-pencil"></i>
                                                                    </asp:LinkButton>
                                                                </td>
                                                            </tr>
